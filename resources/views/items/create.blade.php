                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                @error('minimum_stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Stok untuk alert low stock. Stok awal akan otomatis 0, gunakan transaksi barang masuk untuk menambah stok.</small>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select @error('box_type') is-invalid @enderror" 
                                                    ...
                                                    <option value="dozen" {{ old('box_type') == 'dozen' ? 'selected' : '' }}>Lusin</option>
                                                    <option value="pcs" {{ old('box_type') == 'pcs' ? 'selected' : '' }}>Pcs</option>
                                                </select>
                                                @error('box_type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('box_quantity') is-invalid @enderror" 
                                                       id="box_quantity" name="box_quantity" value="{{ old('box_quantity') }}" min="1">
                                                @error('box_quantity')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('purchase_price') is-invalid @enderror" 
                                           id="purchase_price" name="purchase_price" value="{{ old('purchase_price', 0) }}" min="0" required>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('selling_price') is-invalid @enderror" 
                                           id="selling_price" name="selling_price" value="{{ old('selling_price', 0) }}" min="0" required>
                                </div>
                                @error('selling_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
